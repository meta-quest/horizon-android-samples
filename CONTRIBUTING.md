# Contributing to Horizon Android Samples
...
Meta's internal repository remains the source of truth. It is
...
Meta has a [bounty program](https://www.facebook.com/whitehat/) for the
safe disclosure of security bugs. In those cases, please go through the process
outlined on that page and do not file a public issue.

## License

By contributing to Horizon Android Samples, you agree that your contributions
